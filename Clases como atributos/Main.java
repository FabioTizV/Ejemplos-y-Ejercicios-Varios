...
public class Main 
{
    ...
    Docente decano = new Docente();
      ...
      materias[1] = new Materia("Calculo", new Horario("10:00","11:30"), 
                       "112", 6.5, decano);
      materias[2] = new Materia("Programacion Avanzada", new Horario("11:30","13:00"), 
                       "LabC1", 6.5, oswi);

      Alumno fabio = new Alumno("202012345", true, materias);
      
      System.out.println(fabio.getMaterias()[1].getDocente().getNombre());
